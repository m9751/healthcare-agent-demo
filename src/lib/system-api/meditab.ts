 ...
 *
 * Identical contract to CareStack System API — the Process layer
 * calls both through the same interface. This is the power of
 * API-led connectivity: swap EHR vendors without changing the
 * Process or Experience layers.
 */
...
const SERVER: FhirServerConfig = SERVERS[1]; // Meditab
